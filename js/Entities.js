...
randomlyGenerateEnemy = function(){
	...
	var id = Math.random();
	if(Math.random()<0.5)
		Enemy(id,x,y,width,height,Img.bahamut,100,9999);  //quanity of bullets
	if(Math.random()<0.3)
		Enemy(id,x,y,width,height,Img.dragon,100,9999); //Enemy(id,x,y,width,height,Img.bee,hp,atkspd)
	if(Math.random()<0.4)
		Enemy(id,x,y,width,height,Img.fourdragon,100,9999);
